...
const SongItem = ({ data, onClick }: SongItemProps) => {
  ...
  return (
    ...
    >
      ...
      <div
        className='absolute opacity-0 bottom-[100px] left-5 rounded-full transition translate translate-y-1/4 group-hover:opacity-100 group-hover:translate-y-0 hover:scale-110'
      >
