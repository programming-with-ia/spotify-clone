    ...
    <Root open={isOpen} defaultOpen={isOpen} onOpenChange={onChange}>
      <Portal>
        ...
        <Content
          ...
          md:max-w-[450px] -translate-x-1/2 -translate-y-1/2 rounded-md 
        ...
        >
          ...
          <Close asChild>
            <button
              className='text-neutral-400 hover:text-white absolute top-[10px] right-[10px] inline-flex h-[25px] w-[25px] appearance-noneitems-center justify-center rounded-full focus:outline-none'
            >
              <IoMdClose />
            </button>
          </Close>
